...
const FORM_VIDE: FormCreation = {
  ...
  categorie: "Accompagnement", niveau: "tous", duree_estimee_minutes: "",
  domaine: "", thematique: "", public_cible: "", est_publie: false,
}
...
export default function AdminFormationsPage() {
  ...
  const chargerFormations = async () => {
    ...
    const enrichies = await Promise.all(
      forms.map(async (f) => {
        ...
        return { ...f, nb_modules: nbModules || 0, nb_commences: nbCommences || 0, nb_termines: nbTermines || 0 }
      })
    )
  ...
  const formationsFiltrees = formations.filter((f) =>
    !recherche || f.titre.toLowerCase().includes(recherche.toLowerCase()) ||
            ...
            <tbody>
              {formationsFiltrees.map((f) => (
                <tr key={f.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/50">
                  ...
                  <td className="px-4 py-3">
                    <p className="text-gray-600 text-xs">{f.domaine || "—"}</p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 max-w-xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={formCreate.titre}
              ...
              <div>
                ...
                <input type="text" value={formCreate.slug}
                ...
                <p className="text-xs text-gray-400 mt-1">Généré automatiquement depuis le titre. Ne pas modifier sauf si nécessaire.</p>
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase mb-1">Description courte</label>
                <textarea value={formCreate.description_courte}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select value={formCreate.niveau} onChange={(e) => setFormCreate({ ...formCreate, niveau: e.target.value })}
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#3DBFA0]">
                ...
                <div>
                  ...
                  <input type="text" value={formCreate.public_cible}
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" checked={formCreate.est_publie}
            ...
            <div className="flex gap-3 justify-end mt-6">
              ...
              <button onClick={creerFormation} disabled={createLoading}
