// ─────────────────────────────────────────────────────────────────────────────
// CONTENU — Module 2 : La logique de prévention : lire les situations à risque
...
export const sIntroduction = {
  ...
  titre: "Prévenir : de l'affaire individuelle à la responsabilité partagée",
...
export const sArbre = {
  ...
  schema_etapes: [
    ...
    {
      niveau: "Étape 4",
      nom: "Décider et suivre les mesures",
      definition:
        "Chaque mesure a un responsable et une échéance. Une analyse sans mesures est un rituel ; des mesures sans suivi sont une promesse.",
    },
  ],
  texte_milieu:
...
export const sSituations = {
  ...
  tableau_col2_titre: "Leviers de prévention",
  tableau_col2_items: [
...
export const quiz = [
  {
    question: "Le principe fondateur de la méthode de l'arbre des causes est que :",
    reponses: [
      "Tout incident a une cause principale qu'il faut identifier en priorité",
      "Un incident résulte toujours de la combinaison de plusieurs facteurs, qui isolément seraient restés sans conséquence",
      "La cause d'un incident est presque toujours humaine",
      "L'analyse doit établir les responsabilités de chacun",
    ],
    bonneReponse: 1,
    explication:
  ...
  {
    question:
      "L'équipe décide : « Dorénavant, les refus seront annoncés à deux. » Puis elle se demande : « Au fait, pourquoi les personnes concernées ne participent-elles pas aux décisions qui les concernent ? » Ce second questionnement illustre :",
    reponses: [
      "Une perte de temps par rapport à la première mesure",
      "L'apprentissage en double boucle : on questionne les règles et présupposés, pas seulement l'exécution",
      "L'apprentissage en simple boucle",
      "Une dérive de la réunion hors de son objet",
    ],
    bonneReponse: 1,
    explication:
  ...
  },
  {
    ...
    reponses: [
      "Relève de la seule responsabilité individuelle de chaque professionnel·le",
      "Est une obligation de l'employeur au titre de la protection de la santé (LTr art. 6) et de la personnalité (CO art. 328)",
      "N'est obligatoire que dans le secteur de la santé",
      "Ne concerne que la violence physique, pas la violence verbale",
    ],
    bonneReponse: 1,
    explication:
  ...
  },
  {
    ...
    reponses: [
      "L'identification des « personnes à risque » parmi les usager·ères",
      "Les situations à risque : annonces de refus, attentes, transitions, travail isolé, accumulations non tracées",
      "Le renforcement des sanctions après incident",
      "La sélection de professionnel·les particulièrement résistants au stress",
    ],
    bonneReponse: 1,
    explication:
